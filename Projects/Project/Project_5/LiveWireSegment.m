function contour= LiveWireSegment(im_in,cost_in,slc_dir,slc_num)
disp('entering LiveWireSegment')
...
while ~(done)
    disp('stuck in while loop LiveWireSegment')
    pause(.5);
end
disp('exiting LiveWireSegment')
